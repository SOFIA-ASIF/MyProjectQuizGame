...
let quizQuestion = [{
    ...
    },
    {
        ...
        choices: ["Automatically determining the type of a variable based on its value.", "Explicitly specifying the type of a variable using annotations.", "A feature in TypeScript that allows inferring types from TypeScript libraries.", "A concept unrelated to TypeScript."],
        correctAnswer: "Automatically determining the type of a variable based on its value."
    }, {
        question: "Which of the following is NOT a benefit of using TypeScript?",
        choices: ["Improved code readability",
        ...
        choices: ["To define object types",
        ...
        choices: ["'null' represents the absence of a value, while 'undefined' indicates a variable that has been declared but not assigned a value.", "They are the same.", "'null' represents a defined value that is empty, while 'undefined' indicates the absence of a value.", "'null' is used for numbers, while 'undefined' is used for strings."],
        correctAnswer: "'null' represents the absence of a value, while 'undefined' indicates a variable that has been declared but not assigned a value."
    }, {
        question: "What is the purpose of using generics in TypeScript?",
        choices: ["To create reusable components with type safety",
        ...
        question: "Which configuration file is commonly used to configure TypeScript projects?",
        ...
        question: "How can you ensure type safety in JavaScript code without using TypeScript?",
        choices: ["By writing comprehensive unit tests.", "By using JSDoc annotations.", "By using linting tools like ESLint.", "All of the above."],
        correctAnswer: "All of the above."
    }];
